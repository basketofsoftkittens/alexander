...
class CNN(object):
    ...
    def build(self):
        ...
        re_input = layers.Reshape(
            (-1, self.freq_dim, 1), input_shape=(-1, self.freq_dim)
        )(_input)

        # CNN
        conv1 = (Conv2D(16, (3, 3), strides=(1, 1), activation="relu", padding="same"))(
            re_input
        )
        conv1 = (Conv2D(16, (3, 3), strides=(1, 1), activation="relu", padding="same"))(
            conv1
        )
        conv1 = (Conv2D(16, (3, 3), strides=(1, 3), activation="relu", padding="same"))(
            conv1
        )
        ...
        conv2 = (Conv2D(32, (3, 3), strides=(1, 3), activation="relu", padding="same"))(
            conv2
        )

        conv3 = (Conv2D(64, (3, 3), strides=(1, 1), activation="relu", padding="same"))(
            conv2
        )
        conv3 = (Conv2D(64, (3, 3), strides=(1, 1), activation="relu", padding="same"))(
            conv3
        )
        conv3 = (Conv2D(64, (3, 3), strides=(1, 3), activation="relu", padding="same"))(
            conv3
        )
